 ...
 * @author siddharth
 */
public class TreatmentFollowedInsert extends javax.swing.JFrame {
    ...
    public TreatmentFollowedInsert(Statement s) {
        initComponents();
        stmt = s;
    }
...
//        }
        ...
        try {
            ...
            mArrayList.add("t_id");
            trid = Integer.parseInt(jTextField2.getText());
            mArrayList.add("t_name");
            devby = Integer.parseInt(jTextField3.getText());
            mArrayList.add("pres_by");
            result = jTextField4.getText();
            mArrayList.add("result");
            query += "insert into tr_followed(";
            for (int i = 0; i < mArrayList.size() - 1; i++) {
                query += mArrayList.get(i) + ",";
            }
            query += mArrayList.get(mArrayList.size() - 1) + ") values (" + pid + "," + trid + "," + devby + ",'"+result+"');";//";// + speciality + ");";// + lcons + ",'" + recby + "');";
