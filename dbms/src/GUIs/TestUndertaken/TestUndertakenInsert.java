 ...
 * @author siddharth
 */
public class TestUndertakenInsert extends javax.swing.JFrame {
    ...
    public TestUndertakenInsert(Statement s) {
        initComponents();
        stmt = s;
    }
...
//        }
        ...
        try {
            ...
            query += "insert into test_undertaken(";
            for (int i = 0; i < mArrayList.size() - 1; i++) {
                query += mArrayList.get(i) + ",";
            }
            query += mArrayList.get(mArrayList.size() - 1) + ") values (" + pid + "," + tid + "," + presby + ",'"+result+"');";//";// + speciality + ");";// + lcons + ",'" + recby + "');";
