 ...
 * @author siddharth
 */
public class TreatmentInsert extends javax.swing.JFrame {
    ...
    public TreatmentInsert(Statement s) {
        initComponents();
        stmt = s;
    }
...
//        }
        ...
        try {
            trid = Integer.parseInt(jTextField1.getText());
            mArrayList.add("tr_id");
            trname = jTextField2.getText();
            mArrayList.add("tr_name");
            
            query += "insert into treatment(";
            for (int i = 0; i < mArrayList.size() - 1; i++) {
                query += mArrayList.get(i) + ",";
            }
            query += mArrayList.get(mArrayList.size() - 1) + ") values (" + trid + ",'" + trname + "');";// + speciality + ");";// + lcons + ",'" + recby + "');";
