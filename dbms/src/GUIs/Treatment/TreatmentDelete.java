 ...
 * @author siddharth
 */
public class TreatmentDelete extends javax.swing.JFrame {

    /**
     * Creates new form DoctorDelete
     */
    Statement stmt;
    public  TreatmentDelete(Statement s) {
        initComponents();
        stmt = s;
    }
    ...
    private void initComponents() {
        ...
        jList1.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "tr_id (int)", "tr_name (String)", " " };
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String query = "delete from treatment where "+condition+";";
        try{
